...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="page-header page-header-mini">
        <h1 class="title text-uppercase" style=" text-transform: capitalize;">Latest Blog Posts</h1>
        <ol class="breadcrumb pb-0">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item text-uppercase active">Latest Blog Posts</li>
        </ol>
    </header>
               ...
               @if(isset($blogs) && $blogs->count())
                ...
                <div class="card">
                    <div class="card-header pt-0">
                        <h3 class="card-title mb-4">{{$item->blog_title}}</h3>
                        <div class="blog-media mb-4">
                            <img src="{{ asset($item->blog_image) }}" alt="" class="w-75 article-img"> 
                            @if($item->category)
                        ...
                        <small class="small text-muted d-block mb-2">
                          ...
                          <a href="{{ route('blogs.detailView', $item->blog_id) }}" class="btn btn-sm btn-primary">Read More</a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="card mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="{{ asset('assets/frondend/imgs/blog-1.jpg') }}" alt="" class="w-100">
                                    <a href="#" class="badge badge-primary">#catogery</a>        
                                </div>  
                            </div>
                            <div class="card-body px-0">
                                <!-- <h6 class="card-title mb-2"><a href="#" class="text-dark">news blog</a></h6>   -->
                        ...
                        <div class="card mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="{{ asset('assets/frondend/imgs/blog-4.jpg') }}" alt="" class="w-100">
                                    <a href="#" class="badge badge-primary">#catogery</a>        
                                </div>  
                            </div>
                            <div class="card-body px-0">
                        ...
                        <div class="card mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="{{ asset('assets/frondend/imgs/blog-3.jpg') }}" alt="" class="w-100">
                                    <a href="#" class="badge badge-primary">#catogery</a>        
                                </div>  
                            </div>
                            <div class="card-body px-0">
